...
📦 买家 1 到达：
 ...
 [ 0.7  0.8  1.2]
 [ 0.9  1.   1.4]]
   - 分配后的特征 X_tilde: [[ 0.83230147  0.77201081  0.71338549]
 [ 0.85611823 -0.04087904  0.57292837]
 [ 0.55663475 10.1308107   0.22036108]
 [ 0.61293647  0.93136637  0.72248319]
 [ 0.18630299  0.86890852  1.14984423]
 [ 0.07855805  0.62455129  0.46664051]]
   - 真实值 Y: [1. 2. 3. 4. 5. 6.]
   - 预测值 Y_hat: [1.82490377 1.85422345 3.0061124  3.0245152  5.09225567 6.1979895 ]
✅ 预测增益 G = 0.4675
💰 买家需支付 Revenue = 3.3226
------------------------------------------------------------
📦 买家 2 到达：
   - 真实估值 mu = 20.00
   - 出价 b = 20.00
   - 当前市场定价 p = 17.15
   - 分配前的特征 X: [[0.5 0.1 0.2]
 [0.6 0.2 0.4]
 [0.7 0.3 0.6]
 [0.8 0.4 0.8]
 [0.9 0.5 1. ]
 [1.  0.6 1.2]]
   - 分配后的特征 X_tilde: [[0.5 0.1 0.2]
 [0.6 0.2 0.4]
 [0.7 0.3 0.6]
 [0.8 0.4 0.8]
 [0.9 0.5 1. ]
 [1.  0.6 1.2]]
   - 真实值 Y: [0.5 1.4 3.5 4.6 5.7 6.8]
   - 预测值 Y_hat: [0.5 1.8 3.1 4.4 5.7 7. ]
✅ 预测增益 G = 0.7418
💰 买家需支付 Revenue = 6.0398
------------------------------------------------------------
📦 买家 3 到达：
   - 真实估值 mu = 80.00
   - 出价 b = 80.00
   - 当前市场定价 p = 0.82
   - 分配前的特征 X: [[0.1 0.1 0.2]
 [0.5 0.5 0.6]
 [0.2 0.7 0.8]
 [0.3 0.3 0.4]
 [0.4 0.4 0.5]
 [0.5 0.5 0.6]]
   - 分配后的特征 X_tilde: [[0.1 0.1 0.2]
 [0.5 0.5 0.6]
 [0.2 0.7 0.8]
 [0.3 0.3 0.4]
 [0.4 0.4 0.5]
 [0.5 0.5 0.6]]
   - 真实值 Y: [0.5 1.4 0.5 1.  1.5 2. ]
   - 预测值 Y_hat: [0.47678571 1.7125     0.5        1.09464286 1.40357143 1.7125    ]
✅ 预测增益 G = 0.8178
💰 买家需支付 Revenue = 1.2150
------------------------------------------------------------
📦 买家 4 到达：
   - 真实估值 mu = 50.00
   - 出价 b = 50.00
   - 当前市场定价 p = 89.00
   - 分配前的特征 X: [[0.2 0.4 0.6]
 [0.4 0.8 1.2]
 [0.6 1.2 1.8]
 [0.8 1.6 2.4]
 [1.  2.  3. ]
 [1.2 2.4 3.6]]
   - 分配后的特征 X_tilde: [[0.74413923 0.46927331 0.68887418]
 [0.2559018  0.62116148 1.18097576]
 [0.60169389 1.13646443 2.16188849]
 [1.20947574 1.61750811 2.24264539]
 [0.71846396 1.80334033 2.49742273]
 [1.30529704 2.7117906  3.18547855]]
   - 真实值 Y: [ 2.  4.  6.  8. 10. 12.]
   - 预测值 Y_hat: [ 2.16070117  4.03864521  6.50733099  7.48685789  9.25273035 12.55373439]
✅ 预测增益 G = 0.5147
💰 买家需支付 Revenue = 10.4207
------------------------------------------------------------
📦 买家 5 到达：
   - 真实估值 mu = 30.00
   - 出价 b = 30.00
   - 当前市场定价 p = 86.96
   - 分配前的特征 X: [[0.3 0.6 0.9]
 [0.6 1.2 1.8]
 [0.9 1.8 2.7]
 [1.2 2.4 3.6]
 [1.5 3.  4.5]
 [1.8 3.6 5.4]]
   - 分配后的特征 X_tilde: [[1.32187485 0.83581548 0.71289922]
 [1.23588831 1.61746339 2.19901837]
 [1.97854393 1.93263313 2.90823967]
 [1.69601199 1.52668418 3.57252643]
 [1.2594858  3.69178935 4.73976108]
 [1.80929983 3.81180807 5.414015  ]]
   - 真实值 Y: [ 3.  6.  9. 12. 15. 18.]
   - 预测值 Y_hat: [ 2.14979551  6.91473244  9.61340249 11.72201621 15.04583318 17.55422018]
✅ 预测增益 G = 0.3926
💰 买家需支付 Revenue = 6.1973
------------------------------------------------------------
📦 买家 6 到达：
   - 真实估值 mu = 70.00
   - 出价 b = 70.00
   - 当前市场定价 p = 81.24
   - 分配前的特征 X: [[0.4 0.8 1.2]
 [0.8 1.6 2.4]
 [1.2 2.4 3.6]
 [1.6 3.2 4.8]
 [2.  4.  6. ]
 [2.4 4.8 7.2]]
   - 分配后的特征 X_tilde: [[0.37590096 1.0848378  1.21004592]
 [0.84471573 1.78814908 2.33315686]
 [1.22674405 2.39260931 3.41298805]
 [1.5181891  3.09610674 4.93388159]
 [2.12744899 4.09267912 5.87655286]
 [2.32405571 4.89762389 7.29176767]]
   - 真实值 Y: [ 4.  8. 12. 16. 20. 24.]
   - 预测值 Y_hat: [ 4.0394527   8.07435359 11.73598469 16.09437653 20.13630243 23.91953006]
✅ 预测增益 G = 0.8641
💰 买家需支付 Revenue = 22.6415
------------------------------------------------------------
...
| 步骤 | 说明                         | 输出                        | 对应概念                   | 分析                             |
| -- | -------------------------- | ------------------------- | ---------------------- | ------------------------------ |
| 1  | **真实估值 mu 与出价 b**          | `mu = 10.00`, `b = 10.00` | `μ₁ = b₁`              | 买家报告真实估值，满足 truthfulness 机制假设  |
| 2  | **市场定价 p**                 | `p = 35.93`               | `p₁`                   | 市场高估买家价值，可能导致特征被稀释             |
| 3  | **原始特征 X 与分配后特征 X\_tilde** | `X ≠ X_tilde`，特征被扰动       | `AF(p₁, b₁; X_M)`      | 由于出价远低于定价，买家只获得“变形”后的特征        |
| 4  | **预测过程**                   | `Y_hat ≈ Y`               | `M(X̃)`                | 模型用被扰动的特征训练，预测精度下降             |
| 5  | **预测增益 G**                 | `G = 0.4675`              | `G(Y, Ŷ)`              | 模型提升仍有价值，但受限于特征质量              |
| 6  | **支付 Revenue**             | `Revenue = 3.3226`        | `b * G - ∫₀^b G(z) dz` | 典型 Myerson 支付值，价格较低但因增益有限，支付有限 |

> **解读**：市场定价过高导致特征信息大幅退化，增益有限，体现出市场激励机制对“价格不匹配买家”的惩罚。
...
| 步骤 | 说明                        | 输出       | 对应概念                  | 分析                  |
| -- | ------------------------- | -------- | --------------------- | ------------------- |
| 1  | `mu = 20.00`, `b = 20.00` | 买家诚实     | `μ₂ = b₂`             | 合理出价                |
| 2  | `p = 17.15`               | 市场低估买家价值 | `p₂ < b₂`             | 买家受益：以低市场价买入完整特征    |
| 3  | `X_tilde = X`             | 全部特征无扰动  | `AF(p, b) = Identity` | 买家得到完整数据            |
| 4  | `Y_hat` 非常接近 `Y`          | 高质量预测    | `G = 0.7418`          | 说明数据质量高，模型表现好       |
| 5  | `Revenue = 6.0398`        | 支付值中等    |                       | 虽然增益高，但因为出价也有限，支付受限 |

> **解读**：买家捡了便宜，低市场定价使得他获得了完整数据，但支付值并未过高，体现出 Myerson 支付函数的下界约束。
...
| 3  | `X_tilde = X`      | 获得完整特征     |      |                               |
| 4  | `G = 0.8178`       | 模型性能好      |      |                               |
| 5  | `Revenue = 1.2150` | 非常低的支付     |      | 体现出市场低估导致系统无法有效收取收益（虽然预测提升明显） |

> **解读**：这是论文中“信息泄露”案例的体现 —— 当市场系统无法正确评估买家价值时，容易造成**逆向激励**，高价值买家低价买走好数据。
...
| 3  | `X_tilde ≠ X`       | 特征被扰动    |      |                               |
| 4  | `G = 0.5147`        | 模型表现尚可   |      |                               |
| 5  | `Revenue = 10.4207` | 支付较高     |      | 表明即使数据被扰动，预测仍有增益，但支付受限于 G 的大小 |

> **解读**：此为典型的 Myerson 惩罚机制，出价虽高但因市场定价过高，买家拿到的特征质量受损，系统获得了中等支付值。
...
| 3  | `X_tilde ≠ X`      | 明显特征退化 |      |    |
| 4  | `G = 0.3926`       | 增益较小   |      |    |
| 5  | `Revenue = 6.1973` | 支付仍然中等 |      |    |

> **解读**：再次体现“市场高估 → 特征质量降低 → 预测效果下降”，但因买家出价适中，支付仍维持一定水平。
...
| 3  | `X_tilde ≠ X`       | 中等扰动     |      |                         |
| 4  | `G = 0.8641`        | 非常高的预测提升 |      |                         |
| 5  | `Revenue = 22.6415` | 支付值最大    |      | 表明市场有效地利用了买家预算并提供了高质量数据 |

> **解读**：这是本轮交易中最理想的例子，市场虽略高估买家，但仍提供了较完整的数据，并获得了最大化收益。

---

### 总体对比总结

| 买家 | 出价 vs 定价 | 特征质量    | G    | 支付    | 理论体现        |
| -- | -------- | ------- | ---- | ----- | ----------- |
| 1  | 出价远低于定价  | 特征被大幅降质 | 0.47 | 3.32  | Myerson 惩罚  |
| 2  | 出价略高于定价  | 完整特征    | 0.74 | 6.03  | “买家捡漏”      |
| 3  | 出价远高于定价  | 完整特征    | 0.81 | 1.21  | 市场失策，价值泄露   |
| 4  | 出价远低于定价  | 特征严重变形  | 0.51 | 10.42 | 高价买低质量数据    |
| 5  | 出价中，定价高  | 特征损坏    | 0.39 | 6.20  | 净收益中等       |
| 6  | 出价略低于定价  | 轻微扰动    | 0.86 | 22.64 | 最理想配对，最大化收益 |
